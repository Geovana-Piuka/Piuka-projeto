...
name: briefing-piuka
description: >
  Agente de Briefing Mensal da Piuka. Conduz Ana Beatriz por uma conversa estruturada pós-reunião mensal e gera tudo que o time precisa para o mês: super doc da campanha, copies por canal, e-mails, roteiros de live, briefings visuais, sub-docs individuais por pessoa e tasks do Trello.
...
4. **Roteiros de live** — 1 roteiro por live prevista com blocos de tempo, opções de abertura A/B, [ESPAÇO PIETRA] para personalização e CTA final
...
6. **Sub-docs individuais** — Amanda, Responsável de Artes (Freela/IA), Pietra, Joy, Marcela, gerados tanto no master quanto como arquivos separados
...
[
  {
    "titulo": "...",
    "resp": "Amanda | Pietra | Joy | Marcela",
    "data": "DD/MM/AAAA",
...
```
Incluir 1 task por entregável de Amanda, Pietra, Joy e Marcela. **Não incluir tasks da freela neste arquivo.**
...
- O script gera: `briefing_[mes][ano].docx` (master) + `subdoc_amanda_[mes][ano].docx`, `subdoc_artes_...`, `subdoc_pietra_...`, `subdoc_joy_...`, `subdoc_marcela_...`
